  ...
  return (
    <main className="min-h-screen bg-[var(--bg-body)] text-white flex items-center justify-center px-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-white/70 sort-label">This page drifted off the loft. Let&rsquo;s get you back.</p>
        <div className="flex items-center justify-center gap-3">
          <Link
            href="/"
            className="px-5 py-2 rounded-full bg-[var(--divider)] sort-label font-semibold hover:opacity-90"
          >
            Go home
          </Link>
          <Link
