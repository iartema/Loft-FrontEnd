...
export default function ProgressBar({ value }: ProgressBarProps) {
  return (
    <div className="w-full bg-[var(--bg-elev-1)] rounded-lg p-4 mb-8">
      {/* centered title */}
      ...
      <div className="flex items-center w-full gap-2">
        <div className="relative flex-1 h-2 bg-[var(--border)] rounded-full overflow-hidden">
          <div
            className="absolute left-0 top-0 h-full bg-[var(--success)] rounded-full transition-all duration-300"
            style={{ width: `${value}%` }}
          />
        </div>
